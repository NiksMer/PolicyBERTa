...
# Daten speichern
write_csv(df_train,"PolicyBERTa-8d/trainingsdaten_policy8d_23022022.csv")
write_csv(df_test, "PolicyBERTa-8d/testdaten_policy8d_23022022.csv")
...
# Daten speichern
write_csv(df_train,"PolicyBERTa-7d/trainingsdaten_policy7d_23022022.csv")
write_csv(df_test, "PolicyBERTa-7d/testdaten_policy7d_23022022.csv")
